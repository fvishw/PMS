...
export function DataTable() {
  ...
  const reviewData: ReviewTableColumn[] = data;
        ...
        <Select>
          ...
          <SelectContent>
            <SelectGroup>
              ...
              <SelectItem value="appraisal_review">Appraisal Review</SelectItem>
              <SelectItem value="goal_setting">Reviewer Review</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
      </div>
